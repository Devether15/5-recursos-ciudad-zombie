...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 500, 410, 30, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 140, 450, 30, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 470, 445, 30, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 470, 475, 30, 30, 2),
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 360, 460, 30, 15, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',150, 273, 10, 10, 2,{desdeX: 600, hastaX: 300, desdeY:90, hastaY: 680}),
    new ZombieCaminante('imagenes/zombie2.png',280, 40, 10, 10, 2,{desdeX: 130, hastaX: 400, desdeY:200, hastaY: 600}),
    new ZombieCaminante('imagenes/zombie3.png',90, 500, 10, 10, 2,{desdeX: 140, hastaX: 600, desdeY:300, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie4.png',400, 155, 10, 10, 2,{desdeX: 150, hastaX: 650, desdeY:400, hastaY: 340}),
    new ZombieCaminante('imagenes/zombie1.png',350, 267, 10, 10, 2,{desdeX: 600, hastaX: 30, desdeY:500, hastaY: 140}),
    new ZombieConductor('imagenes/tren_horizontal.png',1200, 0, 90, 30, 5,{desdeY: 322, hastaY: 322, desdeX: -400, hastaX: 1200},'h'),
    new ZombieConductor('imagenes/tren_vertical.png',644, 0, 30, 90, 5,{desdeY: 0, hastaY: 900, desdeX: 644, hastaX: 644},'v'),
    new ZombieConductor('imagenes/tren_vertical.png',678, 0, 30, 90, 5,{desdeY: 0, hastaY: 1200, desdeX: 673, hastaX: 673},'v'),
  ]
